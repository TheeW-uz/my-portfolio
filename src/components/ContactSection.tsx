            ...
            <AnimatePresence mode="wait">
              {success ? (
                ...
                >
                  ...
                  <p className="text-gray-400 max-w-sm">Your email client should have opened with the message ready to send.</p>
                  <button
